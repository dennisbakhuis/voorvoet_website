...
SVG_DIVIDERS = {
    "gentle_1": {
        ...
        "bottom": {
            ...
            "path": "M0,0V15C400,15,600,135,1200,85V0Z",
        },
    },
    "gentle_2": {
        ...
        "bottom": {
            "viewBox": "0 0 1200 120",
            "path": "M0,0V85C400,135,600,15,1200,15V0Z",
        },
    },
    "gentle_3": {
        ...
        "bottom": {
            "viewBox": "0 0 1200 120",
            "path": "M0,0V75C400,45,600,105,1200,15V0Z",
        },
    },
    "gentle_4": {
        ...
        "bottom": {
            "viewBox": "0 0 1200 120",
            "path": "M0,0V45C400,75,600,15,1200,105V0Z",
        },
    },
}
...
def _create_divider(
    divider_data: dict, divider_color: str, position: str
) -> rx.Component:
    """
...
def section(
    ...
    **styles : dict
    ...
    default_padding_top = (
        f"calc({Spacing.section_vertical} + {CLIP_PADDING_COMPENSATION})"
        if clip_top
    ...
    if clip_top and clip_top in SVG_DIVIDERS:
        dividers.append(
            _create_divider(SVG_DIVIDERS[clip_top]["top"], divider_color, "top")
        )
    ...
    if clip_bottom and clip_bottom in SVG_DIVIDERS:
        ...
        dividers.append(
            _create_divider(
                SVG_DIVIDERS[clip_bottom][data_key], divider_color, "bottom"
            )
        )
