...
def footer() -> rx.Component:
    return section(
        container(
            # Main footer layout using nested structure
            rx.box(
                # Logo column (25% on desktop)
                rx.box(
                    rx.image(
                    ...
                    flex=["none", "none", "none", "0 0 25%", "0 0 25%"],
                    margin_bottom=["0", "0", "2rem", "0", "0"]
                ),
                # Content area (75% on desktop)
                rx.box(
                    ...
                    rx.box(
                        ...
                        rx.box(
                            ...
                            rx.box(
                                rx.text("AGB praktijkcode", color="#666", font_weight="600", display="inline-block", width="140px", font_size="20px"),
                        ...
                        # Links at bottom
                        rx.box(
                            rx.link("Credits", href="https://linkedin.com/in/dennisbakuis", color="#3b82f6", text_decoration="underline", display="block", font_size="20px", margin_bottom="0.5rem", text_align=["center", "center", "center", "right", "right"], is_external=True),
                            rx.link("Privacy beleid", href="#", color="#3b82f6", text_decoration="underline", display="block", font_size="20px", margin_bottom="0.5rem", text_align=["center", "center", "center", "right", "right"]),
                            rx.link("Algemene voorwaarden", href="#", color="#3b82f6", text_decoration="underline", display="block", font_size="20px", text_align=["center", "center", "center", "right", "right"])
                        ),
                        display="flex",
                    ...
                    flex=["none", "none", "none", "0 0 75%", "0 0 75%"]
                ),
