...
TRANSLATIONS = {
    "nl": {
        ...
        "image_alt": "Skelet van voetbot jes - podotherapie behandelt voetklachten",
    },
    "de": {
        ...
        "image_alt": "Skelett der Fußknochen - Podotherapie behandelt Fußbeschwerden",
    },
    "en": {
        ...
        "image_alt": "Skeleton of foot bones - podotherapy treats foot complaints",
    },
}
...
def section_what_is_podiatry(language: str) -> rx.Component:
    ...
    return section(
        container(
            image_text_section(
                image_fallback="/images/page_information/skelet_botjes_voet_voorvoet_praktijk_voor_podotherapie_enschede.jpg",
                image_avif="/images/page_information/skelet_botjes_voet_voorvoet_praktijk_voor_podotherapie_enschede.avif",
                image_webp="/images/page_information/skelet_botjes_voet_voorvoet_praktijk_voor_podotherapie_enschede.webp",
